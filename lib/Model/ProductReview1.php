...
/**
 * ProductReview1 Class Doc Comment
 *
 * @category Class
 * @package  WooCommerce\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductReview1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'product_review_1';
...
self::STATUS_UNTRASH,        ];
     ...
     * Sets product_id
     *
     * @param int $product_id Unique identifier for the product.
     *
     * @return $this
     */
