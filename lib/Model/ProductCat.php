 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductCat implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'product_cat';
...
'description' => 'string',
'display' => 'string',
'image' => '\WooCommerce\Client\Model\ProductscategoriesImage',
'menu_order' => 'int',
'count' => 'int'    ];
...
'count' => 'getCount'    ];
    ...
    const DISPLAY__DEFAULT = 'default';
...
self::DISPLAY_BOTH,        ];
     ...
     * Sets parent
     *
     * @param int $parent The ID for the parent of the resource.
     *
     * @return $this
     */
     ...
     * Gets image
     *
     * @return \WooCommerce\Client\Model\ProductscategoriesImage
     */
     ...
     * Sets image
     *
     * @param \WooCommerce\Client\Model\ProductscategoriesImage $image image
     *
     * @return $this
     */
     ...
     * Sets menu_order
     *
     * @param int $menu_order Menu order, used to custom sort the resource.
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count Number of published products for the resource.
     *
     * @return $this
     */
