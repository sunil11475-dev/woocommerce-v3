 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShopCoupon implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'shop_coupon';
...
self::DISCOUNT_TYPE_FIXED_PRODUCT,        ];
     ...
     * Sets date_created
     *
     * @param string $date_created The date the coupon was created, in the site's timezone.
     *
     * @return $this
     */
     ...
     *
     * @param string $date_created_gmt The date the coupon was created, as GMT.
     *
     * @return $this
     */
     ...
     * Sets date_modified
     *
     * @param string $date_modified The date the coupon was last modified, in the site's timezone.
     *
     * @return $this
     */
     ...
     *
     * @param string $date_modified_gmt The date the coupon was last modified, as GMT.
     *
     * @return $this
     */
     ...
     * Sets usage_count
     *
     * @param int $usage_count Number of times the coupon has been used already.
     *
     * @return $this
     */
     ...
     * Sets used_by
     *
     * @param int[] $used_by List of user IDs (or guest email addresses) that have used the coupon.
     *
     * @return $this
     */
